...
# Authors: Michael Haag, Nasreddine Bencherchali
# Version: 1.0
...
fileExtensions = {
    ...
    ".lua": [{"operation": "gt", "value": 4.15186444439319}],
...
heuristicRules = [
    ...
    {"pattern": "assert%(", "description": "Use of assert function"},
    {
        ...
        "description": "Use of preg_replace with /e modifier",
    },
    ...
    {"pattern": "require_once%(", "description": "Use of require_once function"},
    {
        ...
        "description": "Use of file_get_contents function",
    },
    ...
    {"pattern": "gzdecode%(", "description": "Use of gzdecode function"},
    {
        ...
        "description": "Use of preg_replace_callback function",
    },
    {"pattern": "call_user_func%(", "description": "Use of call_user_func function"},
    {
        "pattern": "call_user_func_array%(",
        "description": "Use of call_user_func_array function",
    },
    ...
    {"pattern": "array_reduce%(", "description": "Use of array_reduce function"},
    {
        ...
        "description": "Use of register_shutdown_function",
    },
    {
        "pattern": "register_tick_function%(",
        "description": "Use of register_tick_function",
    },
    ...
    {"pattern": "preg_filter%(", "description": "Use of preg_filter function"},
    {
        ...
        "description": "Use of file_put_contents function",
    },
    ...
    {"pattern": "copy%(", "description": "Use of copy function"},
    {
        ...
        "description": "Use of move_uploaded_file function",
    },
    ...
    {
        "pattern": "session_regenerate_id%(",
        "description": "Use of session_regenerate_id function",
    },
    ...
    {"pattern": "pfsockopen%(", "description": "Use of pfsockopen function"},
    {
        ...
        "description": "Use of stream_socket_client function",
    },
    {
        "pattern": "stream_socket_server%(",
        "description": "Use of stream_socket_server function",
    },
    {
        "pattern": "stream_context_create%(",
        "description": "Use of stream_context_create function",
    },
    {
        "pattern": "stream_context_set_option%(",
        "description": "Use of stream_context_set_option function",
    },
    {
        "pattern": "stream_context_get_options%(",
        "description": "Use of stream_context_get_options function",
    },
    {
        "pattern": "stream_filter_append%(",
        "description": "Use of stream_filter_append function",
    },
    {
        "pattern": "stream_filter_prepend%(",
        "description": "Use of stream_filter_prepend function",
    },
    {
        "pattern": "stream_get_contents%(",
        "description": "Use of stream_get_contents function",
    },
    {
        "pattern": "stream_set_blocking%(",
        "description": "Use of stream_set_blocking function",
    },
    {
        "pattern": "stream_set_timeout%(",
        "description": "Use of stream_set_timeout function",
    },
    {
        "pattern": "stream_set_write_buffer%(",
        "description": "Use of stream_set_write_buffer function",
    },
    {
        "pattern": "stream_socket_enable_crypto%(",
        "description": "Use of stream_socket_enable_crypto function",
    },
    {
        "pattern": "stream_socket_shutdown%(",
        "description": "Use of stream_socket_shutdown function",
    },
    {
        "pattern": "eval%(base64_decode%(",
        "description": "Use of eval with base64_decode",
    },
    {"pattern": "phpinfo%(", "description": "Use of phpinfo function"},
    {
        "pattern": "get_defined_vars%(",
        "description": "Use of get_defined_vars function",
    },
    {
        "pattern": "get_defined_functions%(",
        "description": "Use of get_defined_functions function",
    },
    {
        "pattern": "get_included_files%(",
        "description": "Use of get_included_files function",
    },
    {
        "pattern": "get_required_files%(",
        "description": "Use of get_required_files function",
    },
    ...
    {"pattern": "parse_str%(", "description": "Use of parse_str function"},
    {
        ...
        "description": "Use of mb_ereg_replace with /e modifier",
    },
    {
        "pattern": "mb_eregi_replace%(.*/e",
        "description": "Use of mb_eregi_replace with /e modifier",
    },
    ...
    {
        "pattern": "ReflectionZendExtension%(",
        "description": "Use of ReflectionZendExtension",
    },
]
...
def getEntropy(content):
    length = len(content)
    symbolFrequency = {}

    for symbol in content:
        if symbolFrequency.get(symbol, 0):
            symbolFrequency[symbol] += 1
        else:
            symbolFrequency[symbol] = 1

    entropy = 0
    for frequency in symbolFrequency.values():
...
def detectWebshellPatterns(suspiciousPatterns, fileContent):
    matchedPatterns = []
    for pattern in suspiciousPatterns:
        if pattern in fileContent:
...
def performHeuristicAnalysis(heuristicRules, fileContent):
    matchedHeuristics = []
    for rule in heuristicRules:
        if rule["pattern"] in fileContent:
            matchedHeuristics.append(rule["description"])

    return matchedHeuristics


# Adjust confidence score based on matched patterns and heuristics
def adjustConfidenceScore(baseScore, matchedPatterns, matchedHeuristics):
    confidenceScore = baseScore * 100

    if len(matchedPatterns) > 0:
        scoreAdjustment = 0.25 * len(matchedPatterns)
        confidenceScore = confidenceScore + scoreAdjustment * 100

    if len(matchedHeuristics) > 0:
        scoreAdjustment = 0.25 * len(matchedHeuristics)
        confidenceScore = confidenceScore + scoreAdjustment * 100
...
def createResultObject(
    ...
    result = {
        ...
        "suspiciousKeywords": matchedPatterns,
...
def scanDirectories(
        ...
        for path, subdirs, files in os.walk(directoryPath):
            for name in files:
                ...
                for excludePath in excludePaths:
                    if excludePath in file_path:
                        exclude = True
                        break
                _, extension = os.path.splitext(file_path)

                if extension and (extension in fileExtensions.keys()):
                    with open(file_path, "r") as f:
                        content = f.read()

                    entropy = getEntropy(content)
                    hash = calculate_sha256(file_path)

                    if hash:
                        for condition in fileExtensions[extension]:
                            # '.asp': [{'operation':'lt', 'value':0.805376867704514}, {'operation':'gt', 'value':5.51268104400858}],
                            operation = condition["operation"]
                            value = condition["value"]
                            metCondition = False

                            if (
                                (operation == "gt" and entropy > value)
                                or (operation == "lt" and entropy < value)
                                or (operation == "eq" and entropy == value)
                            ):
                                metCondition = True

                            if metCondition and (hash not in ignoreHashes):
                                matchedPatterns = detectWebshellPatterns(
                                    suspiciousPatterns, content
                                )
                                matchedHeuristics = performHeuristicAnalysis(
                                    heuristicRules, content
                                )
                                confidenceScore = adjustConfidenceScore(
                                    0.5, matchedPatterns, matchedHeuristics
                                )
                                ...
                                result = createResultObject(
                                    ...
                                    matchedPatterns,
                                    matchedHeuristics,
                                    base64.b64encode(bytes(content.encode("utf-8"))),
                                )

                                print(result)

                                webshellFound = True
                                potentialWebshells += 1
                    else:
                        print("Error calculating the hash of the file")
    ...
    scanStats = {
        ...
        "ScanDuration": str(scanDuration) + "s",
    }

    print("Scan completed. Statistics:")
    for k, v in scanStats.items():
        print(k + ": " + str(v))


# Directories to scan
directoryPaths = ["/opt/webshells"]

# Directories to exclude
excludePaths = ["exclude_path1", "exclude_path2", "exclude_path3"]
...
try:
    with open(ignoreHashesFilePath, "r") as f:
        ignoreHashes = []
        for i in [j.strip() for j in f.readlines()]:
            ignoreHashes.append(i)
except:
    print(f"Error opening file. {ignoreHashesFilePath} was not found.")
