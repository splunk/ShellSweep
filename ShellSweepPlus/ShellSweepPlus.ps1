...
$heuristicRules = @(
    ...
    @{ 'pattern' = 'preg_replace\s*\(\s*''.*?''\s*,\s*''.*?''\s*,\s*\$'; 'description' = 'Potential code execution via preg_replace' },
    ...
    @{ 'pattern' = 'preg_replace\s*\(\s*''.*?''\s*,\s*''.*?''\s*,\s*\$'; 'description' = 'Use of preg_replace with /e modifier' },
    ...
    @{ 'pattern' = 'preg_replace\s*\(\s*''.*?''\s*,\s*''.*?''\s*,\s*\$_(?:GET|POST|REQUEST|COOKIE|SERVER)\['; 'description' = 'Potential code execution via preg_replace with user input' },
